...
<body class="search-page marble-bg">
<<div>
        ...
        <form action="booksave.php" method="POST" enctype="multipart/form-data">
            <div class="form-row profile-row">
                <div class="col-md-4 relative">
                    <div class="avatar sellpage-logo">
                        <div class="avatar-bg center"></div>
                    </div><input type="file" class="form-control" name="file1"></div>
                <div class="col-md-8">
                    <h1>Book Information</h1>
                    <hr>
                    <div class="form-row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label>Book Name*</label><input class="form-control" type="text" name="bookname" required="required" ></div>
                            <div class="form-group"><label>Edition</label><input class="form-control" type="tel" name="edition" ></div>
                            <div class="form-group"><label>Condition (New/Like new/Used)</label><input class="form-control" type="text" name="condition" ></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label>Author</label><input class="form-control" type="text" name="bookau" ></div>
                            <div class="form-group"><label>ISBN</label><input class="form-control" type="text" name="isbn" ></div>
                            <div class="form-group"><label>Course</label><input class="form-control" type="text" name="course" ></div>
                        </div>
                    </div>
                    <div class="form-group"><label>Contact Email*</label><input class="form-control" type="email" autocomplete="off" required="" name="email" ></div>
                    <div class="form-group"><label>Book Description</label><textarea class="form-control descrip-box" name="content" ></textarea></div>
                    <div class="form-group"><label>Price*</label><input class="form-control price-box" type="text" placeholder="$" name="price" required="required"></div>
                    <hr>
                    <div class="form-row">
                        <div class="col-md-12 content-right"><button class="btn btn-primary form-btn" type="submit">POST</button><button class="btn btn-danger form-btn" type="reset">CANCEL </button></div>
                    </div>
                </div>
            </div>
        </form>
