...
<div>
    ...
    <div class="login-clean">
        <div>
            <form id="loginform" action="save.php" method="POST" enctype="multipart/form-data">
                <div class="illustration"><img src="assets/img/logo.png">
                    <h3 class="text-primary">Sign Up</h3>
                </div>
                <div class="form-group"><input class="form-control log-input" type="text" placeholder="User Name" name="user" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="text" placeholder="First Name" name="firstname" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="text" placeholder="Last Name" name="lastname" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="email" placeholder="Email" name="email2" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="password"  placeholder="Password" name="pwd" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="password"  placeholder="Comfired Password" name="pwd2" required=""></div>
                <div class="form-group"><input class="form-control log-input" type="password"  placeholder="Hit: for password reset" name="hit" required=""></div>
                
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a href="login.php" class="forgot">Already have an account?</a></form>
            
        </div>
    </div>
    <div class="footer-2" style="margin-top:0;">
        <div class="container">
            <div class="row">
