...
<div>
    ...
    <h2 class="trans-h">Reset password fail, your username, email, or hit is incorrect</h2>
    <p class="trans-l"><a href="pwreset.php" class="trans-l">Back to reset password page</a></p>
    <div class="footer-2">
        <div class="container">
            <div class="row">
