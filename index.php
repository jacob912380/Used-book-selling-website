...
<div>
    ...
    <div id="intro">
        <div class="jumbotron">
            <h1 class="text-primary">BAIBOOK</h1>
            <p class="text-secondary">A textbook assistant for student</p>
            <p><a class="btn btn-primary" role="button" href="login.php">Get Start!</a></p>
        </div>
    </div>
    <div class="container">
        <div class="row middle-text">
            <div class="col-4 my-auto"><i class="fa fa-book"></i>
                <h5>Easy Textbook</h5>
            </div>
            <div class="col-4 my-auto"><i class="fa fa-github-alt"></i>
                <h5>For Student</h5>
            </div>
            <div class="col-4 my-auto"><i class="fa fa-building"></i>
                <h5>Trade In Campus</h5>
            </div>
        </div>
    </div>
    <div></div>
