...
<div>
    ...
    <h2>Search</h2>
    <div class="d-block search-bar">
    <form  id="search-form" action="searchresult.php" method="post">
            <div class="form-group" id="search-line">
                <p>Book Name</p><input class="form-control" type="text" name="bookname"></div>
            <div class="form-group" id="search-line">
                <p>Author</p><input class="form-control" type="text" name="bookau"></div>
            <div class="form-group" id="search-line">
                <p>ISBN</p><input class="form-control" type="text" name="isbn"></div>
            <div class="form-group" id="search-line">
                <p>Edition</p><input class="form-control" type="text" name="edition"></div>
            <div class="form-group" id="search-line">
                <p>Course Name</p><input class="form-control" type="text" name="course"></div>
            <div class="form-group" id="search-line">
                
                
                <p>Conditione</p><input class="form-control" type="text" name="condition"></div>
                <option value="12" selected=""></select></div>
            <div class="form-group" id="search-line">
            <button class="btn btn-secondary btn-lg search-button" type="SUBMIT" value="Search" name="submit">Search</button></div>
        </form>
