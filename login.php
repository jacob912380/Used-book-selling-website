    ...
    <div class="login-clean">
        <div>
            <form action="index.php" method="post" id="loginform">
                ...
                <div class="form-group"><input class="form-control log-input" type="password" name='pwd' placeholder="Password" required=""></div>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button></div><a href="pwreset.php" class="forgot">Forgot your password?</a></form>
