...
<div>
    ...
    <h2 class="trans-h">Upload picture format incorrect. <br> Please upload .jpg or.png format less than 2MB</h2>
    <p class="trans-l"><a href="sell.php" class="trans-l">Back to selling page</a></p>
    <div class="footer-2">
        <div class="container">
            <div class="row">
