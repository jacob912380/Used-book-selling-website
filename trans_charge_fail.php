...
<div>
    ...
    <h2 class="trans-h">You need to fill out your shipping address</h2>
    <p class="trans-l"><a href="profile.php" class="trans-l">Add your shipping address on your profile</a></p>
    <div class="footer-2">
        <div class="container">
            <div class="row">
